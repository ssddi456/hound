...
```
go get github.com/ssddi456/hound/cmds/...
```
...
```
git clone https://github.com/ssddi456/hound.git hound/src/github.com/ssddi456/hound
cd hound
src/github.com/ssddi456/hound/tools/setup
make
```
